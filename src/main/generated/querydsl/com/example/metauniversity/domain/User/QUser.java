...
public class QUser extends EntityPathBase<User> {
    ...
    public final com.example.metauniversity.domain.File.QUserFile userfile;
    ...
    public QUser(Class<? extends User> type, PathMetadata metadata, PathInits inits) {
        ...
        this.userfile = inits.isInitialized("userfile") ? new com.example.metauniversity.domain.File.QUserFile(forProperty("userfile"), inits.get("userfile")) : null;
