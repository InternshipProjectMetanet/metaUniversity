...
public class ReplyController {
	 ...
	 */
	 ...
	 public Reply getRelyList(@PathVariable int boardId) {
...
//	@GetMapping(value = "/reply/{boardId}")
//	public JsonObject getRelyList(@PathVariable("reply") Long boardId, @ModelAttribute("params") replyDto.insertReply params) {
//		
//		JsonObject jsonObj = new JsonObject();
//
